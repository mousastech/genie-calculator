...
app = FastAPI(title="Genie Cost Calculator")
...
PERSONA_HINTS = {
    "genieOne": {
        "beginner": "~3-7 perguntas/mês · exploração leve e ocasional",
        "practitioner": "~11-21/mês · analytics self-service regular",
        "power": "~35-65/mês · análise iterativa diária",
        "superPower": "~103-181/mês · workflows analíticos pesados",
    },
    "genieAgent": {
        "beginner": "~4-9 mensagens/mês · perguntas agênticas ocasionais",
        "practitioner": "~11-23/mês · análise agêntica regular",
        "power": "~26-57/mês · investigações multi-etapa frequentes",
        "superPower": "~48-145/mês · workflows agênticos pesados diários",
    },
}
